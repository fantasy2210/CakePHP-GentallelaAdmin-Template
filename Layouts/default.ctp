...
<html lang="en">
    <head>
        ...
        <title>Gentellela Alela! | Layout 2 </title>
        ...
        <!-- Custom Theme Style -->
        <?php echo $this->Html->css('/build/css/custom.css') ?>
    ...
    <body class="nav-md">
                    ...
                    <div class="left_col scroll-view">
                        ...
                        <div class="profile">
                            <div class="profile_pic">
                                <?php echo $this->Html->image('img.jpg', array('alt' => "...", 'class' => "img-circle profile_img")) ?>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        <?php echo $this->Html->image('img.jpg', array('alt' => "...")) ?>John Doe
                                ...
                                <li role="presentation" class="dropdown">
                                    ...
                                    <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                                        <li>
                                            <a>
                                                <span class="image"><?php echo $this->Html->image('img.jpg', array('alt' => "Profile")) ?></span>
                                                <span>
        ...
        <?php echo $this->Html->script('moment/moment.min.js') ?>
        <?php echo $this->Html->script('datepicker/daterangepicker.js') ?>

        <!-- Custom Theme Scripts -->
        <?php echo $this->Html->script('/build/js/custom.js') ?>
